...
description: |
  Use this agent when you need to implement features, write code, or develop functionality for a project. Use this agent proactively whenever you need to write code for a task. Examples:

  <example>
  Context: User needs a feature implemented
  user: "Implement the authentication service"
  assistant: "I'll use the Task tool to launch the senior-developer agent to implement the authentication service."
  <commentary>
  Any feature implementation task should use the senior-developer agent.
  </commentary>
  </example>
---
