...
### Changed
- **conventional-commit skill** - Moved Best Practices into `commit-patterns.md` reference file and removed redundant When to Use section for cleaner skill definition

## [1.0.3] - 2026-03-29

### Changed
- **comprehensive-review skill** - Added "deep code review" and "deep review" as trigger phrases to improve discoverability

## [1.0.2] - 2026-03-24

### Changed
- **conventional-commit skill** - Added "generate commit" as a trigger phrase
